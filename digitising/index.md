...
A form will open where you can enter the relevant attribute data for the Kiraman language area. Note that here we manually update the id (`2`) after splitting, but we could also choose to autogenerate a new id."
